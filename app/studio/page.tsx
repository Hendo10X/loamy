...
import { GradientPresets } from "@/components/token-studio/gradient-presets"
      ...
      <main className="mx-auto max-w-5xl space-y-12 px-4 py-8 sm:space-y-16 sm:px-6 sm:py-10">
        ...
        <section className="pb-16">
          <SectionHeader
            ...
            subtitle="Click any gradient to copy the CSS — derived from your palette"
          />
          <GradientPresets palette={palette} />
        </section>
      </main>
    </div>
  )
